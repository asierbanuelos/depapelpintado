...
class Admin_library extends CI_Controller {
    ...
    function islogged(){
      if($this->session->userdata('hash')!=md5($this->user['user'].$this->user['pass']))redirect ('tienda');
    }
    function contenido(){
    ...
    function editpagina($a=""){
      ...
      $this->load->model('contenido_model');
      $this->data['pagina']=$this->contenido_model->get_page($a);
    ...
    function noimg($fab=0,$col=0,$page=0,$todos=0,$order='item_id'){
      if(isset($_POST['fab']))$fab=$_POST['fab'];
      if(isset($_POST['col']))$col=$_POST['col'];
      if(isset($_POST['todos']))$todos=1;
      ...
      $this->data['gama']=$this->demo_cart_admin_model->get_gama_array();
      $this->data['estilo']=$this->demo_cart_admin_model->get_estilo_array();
      $this->data['count']=$this->demo_cart_admin_model->get_items_count($fab,$col,$todos);
      $this->data['all']=$this->demo_cart_admin_model->get_items_filter($fab,$col,$page,$todos,$order);
    ...
    function fabricantes(){
      $this->load->model('demo_cart_admin_model');
      $this->data['fab']=$this->demo_cart_admin_model->get_categories("ASC");
    ...
    function colecciones(){
      ...
      $this->data['col']=$this->demo_cart_admin_model->get_colecciones(0,"ASC");
    ...
    function colores(){
      $this->load->model('demo_cart_admin_model');
      $this->data['colores']=$this->demo_cart_admin_model->get_gama_array("DESC");
