...
class Flexi_cart_lite
{
	 ...
	 */
	public function shipping_total($inc_discount = TRUE, $format = TRUE, $internal_value = FALSE, $portes_especiales=0)
	{		
		...
		$non_discounted_shipping_total = $this->CI->flexi->cart_contents['summary']['shipping_total'] + $portes_especiales;
		...
		if(isset($_GET['proba']) && $_GET['proba']=='eneko'){
	        echo "<br />inc_discount: $inc_discount";
	        echo "<br />non_discounted_shipping_total: $non_discounted_shipping_total";
	        echo "<br />discounted_shipping_total: $discounted_shipping_total";
	        print '<pre><xmp>';
	        print_r($this->CI->flexi->cart_contents);
	        print '</xmp></pre>';
		}
		...
		return $this->format_currency(floor(($non_discounted_shipping_total - $discounted_shipping_total)*100)/100, $format, 2, $internal_value);
	}
