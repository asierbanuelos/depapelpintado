...
class Flexi_cart_eneko_model extends Flexi_cart_lite_model
{
        ...
        function get_item($id=0,$cat=0){
         if($cat!=5) {
          ...
          ->join('demo_estilo', 'estilo_id = estilo_item_estilo')
            ...
            return $temp->get()->row_array();
        }
        function get_variantes($id){
          
          return $this->db->select("*",FALSE)->from('demo_items')->where('item_id',$id)->or_where('variante_de',$id)->get()->result_array();
        }
    ...
    function get_items_cole ($cole="",$todos=false,$categ=-1){
      ...
      $temp->from('demo_items')
            ...
            if($categ>-1)$temp->where('demo_items.item_tipo',$categ);
             return $temp->group_by('item_id')->order_by('item_ref')->get()->result_array();
    }
