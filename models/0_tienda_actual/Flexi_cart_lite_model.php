...
{	
	 ...
	 */
	public function format_calculation($number = 0, $decimals = 2, $sanitize = TRUE)
	{
		if ($sanitize)
		{
	...
	public function calculate_string($string) 
	{
		...
		$calculate = $this->create_function_aux('', 'return ('.$string.');');
		/*
		$calculate = function () {
		  return ($string);
		};
	...
	//if ( ! function_exists( "create_function" ) ) {
	    private function create_function_aux( $arg, $body ) {
