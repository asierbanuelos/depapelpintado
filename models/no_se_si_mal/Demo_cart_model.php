...
class Demo_cart_model extends CI_Model {
			...
			if($this->input->post('ud')=="m2"){
              ...
              $cart_data = array(
				...
				*/
                ...
                $cart_data = array(
				'id' => $item_id, 
				'name' => "Herramientas - ". $fab." - ".$item_data['item_ref'], 
				'quantity' => $qty, 
				...
				*/
                ...
                $cart_data = array(
				'id' => $item_id, 
				'name' => $fab." - ". $col." - ".$item_data['item_ref'].$extra_info_item, 
				'quantity' => $qty, 
				'price' => $item_data['item_price'], 
				/*
				'precio_unitario_final' => $precio_unitario_final,
	...
	function demo_save_order()
	{
		...
		$this->form_validation->set_rules('checkout[shipping][city]', 'Ciudad  ', 'required');
		...
		$this->form_validation->set_rules('checkout[phone]', 'Phone Number', 'required|min_length[9]');
