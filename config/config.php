...
|
*/
//$config['base_url'] = 'https://nueva.depapelpintado.es/';
$config['base_url'] = 'https://www.depapelpintado.es/';
...
$config['encryption_key'] = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
