...
*/
	...
	*/
	...
	$config['database']['discounts_ekam']['table'] = 'discounts_ekam';
	$config['database']['discounts_ekam']['columns']['id'] = 'disc_id'; 
	$config['database']['discounts_ekam']['columns']['type'] = 'disc_type_fk';
	$config['database']['discounts_ekam']['columns']['method'] = 'disc_method_fk';
	$config['database']['discounts_ekam']['columns']['tax_method'] = 'disc_tax_method_fk';
	$config['database']['discounts_ekam']['columns']['user'] = 'disc_user_acc_fk'; 
	$config['database']['discounts_ekam']['columns']['item'] = 'disc_item_fk'; 
	$config['database']['discounts_ekam']['columns']['group'] = 'disc_group_fk';
	$config['database']['discounts_ekam']['columns']['location'] = 'disc_location_fk';
	$config['database']['discounts_ekam']['columns']['zone'] = 'disc_zone_fk';
	$config['database']['discounts_ekam']['columns']['code'] = 'disc_code'; 
	$config['database']['discounts_ekam']['columns']['description'] = 'disc_description'; 
	$config['database']['discounts_ekam']['columns']['quantity_required'] = 'disc_quantity_required'; 
	$config['database']['discounts_ekam']['columns']['quantity_discounted'] = 'disc_quantity_discounted'; 
	$config['database']['discounts_ekam']['columns']['value_required'] = 'disc_value_required'; 
	$config['database']['discounts_ekam']['columns']['value_discounted'] = 'disc_value_discounted'; 
	$config['database']['discounts_ekam']['columns']['recursive'] = 'disc_recursive'; 
	$config['database']['discounts_ekam']['columns']['non_combinable'] = 'disc_non_combinable_discount';
	$config['database']['discounts_ekam']['columns']['void_reward_points'] = 'disc_void_reward_points';
	$config['database']['discounts_ekam']['columns']['force_shipping_discount'] = 'disc_force_ship_discount';
	$config['database']['discounts_ekam']['columns']['custom_status_1'] = 'disc_custom_status_1';
	$config['database']['discounts_ekam']['columns']['custom_status_2'] = 'disc_custom_status_2';
	$config['database']['discounts_ekam']['columns']['custom_status_3'] = 'disc_custom_status_3';
	$config['database']['discounts_ekam']['columns']['usage_limit'] = 'disc_usage_limit';   
	$config['database']['discounts_ekam']['columns']['valid_date'] = 'disc_valid_date'; 
	$config['database']['discounts_ekam']['columns']['expire_date'] = 'disc_expire_date'; 
	$config['database']['discounts_ekam']['columns']['status'] = 'disc_status'; 
	$config['database']['discounts_ekam']['columns']['order_by'] = 'disc_order_by'; 
	...
	$config['database']['discount_group_items_ekam']['table'] = 'discount_group_items_ekam';
	$config['database']['discount_group_items_ekam']['columns']['id'] = 'disc_group_item_id'; 
	$config['database']['discount_group_items_ekam']['columns']['group'] = 'disc_group_item_group_fk'; 
	$config['database']['discount_group_items_ekam']['columns']['item'] = 'disc_group_item_item_fk'; 
	...
	$config['messages']['target_user']['discount_already_used_by_user'] = 'public';
	$config['messages']['target_user']['discount_login_required'] = 'public';
	$config['messages']['target_user']['discount_already_used_by_ip'] = 'public';
