...
<!--  html plano ficha-->
 ...
 <div class="units-row units-split end">
   ...
   <h2 id="inicio" class="tituloficha"> <?if(isset($migas))echo $migas;?>
   	<?
   if($categ!=5){  	
...
<div class="unit-50">
 ...
 <div class="estilazo">
  ...
  <?=($key['item_vinilo']==1 && $key['item_tipo']==1)?"<li><b>Fotomural vinílico</b></li>":""?>
 ...
 <?}?>
    ...
    <li>Limpieza:<br> 
      ...
      foreach($limp as $k){
       if($k==0)echo '<img src="'.$includes_dir.'iconos/0.jpg" title="Limpieza en seco"/>';
       if($k==1)echo '<img src="'.$includes_dir.'iconos/1.jpg" title="Lavadora"/>';
       if($k==2)echo '<img src="'.$includes_dir.'iconos/2.jpg" title="A mano"/>';
       if($k==3)echo '<img src="'.$includes_dir.'iconos/3.jpg" title="No centrifugar"/>';
       if($k==4)echo '<img src="'.$includes_dir.'iconos/4.jpg" title="No secadora"/>';
       if($k==5)echo '<img src="'.$includes_dir.'iconos/5.jpg" title="Sin Lejia"/>';
      }
      ?>
    </li>
    <?}?>
...
<p ><input type="text" class="metrs calcuinput" placeholder="Ancho en metros" value="" id="p_ancho" name="p_ancho" ><input type="text" class="metrs calcuinput" placeholder="Alto en metros" value="" id="p_alto" name="p_alto" ><button id="calculaboton">Calcular</button>
</p> 
...
<?}?>
<p class="unidades"> Unidades: <input type="text" id="unidades" name="unidades" value="1"/><input type="hidden" id="ud" name="ud" value="<?=$key['item_unidad']?>"/> <?=($key['item_unidad']=='m2')?"":$key['item_unidad']?> </p> 
...
<p class="precio magenta-secundario"><b>Precio: </b><?
 ...
 // print_r($key);
  ...
  else if($key['disc_status']==1 && $key['disc_type_fk']==1 && $totalcarro>=$key['disc_value_required']){//tipo de descuento
  ...
  ?><div class="precio magenta-secundario" style="display:none" id="importe">Importe: <span><?=$precio?></span></div></p>
...
<div style="display:none" id="dialog-confirm" title="Se ha añadido el artículo">
  <p><span><img style="width:60px; margin-right:10px;" src="<?=$t?>th.jpg"/> <?=(isset($key['cat_name']))?$key['cat_name']:$key['item_name']?> - <?=(isset($key['coleccion_name']))?$key['coleccion_name']:""?> - <?=$key['item_ref']?> : <span id="importevalor"></span></span></p>
</div>
