  ...
  <div class="container">
    ...
    <div class='row'>
      ...
      <div class="col-xl-9 col-lg-9 col-md-8 col-12">
        ...
        ?>
        <div class="col-12 text-cener d-md-none">
          <button class="navbar-toggler p-0 py-2 mt-2 mb-4 w-100 boton-opciones" type="button" data-toggle="canvas" data-target="#bs-canvas-right" aria-controls="s-canvas-right" aria-expanded="false" aria-label="Toggle filter">
            <span class="navbar-toggler-icon" style="padding-top: 1px;"><i class="fa fa-list-ul"></i></span>
            <span class=''>VER FILTROS</span>
          </button>
        </div>
        <?php 
        $this->load->view('frontend/cuerposeccion-filtros-movil', $this->data); 
        ?>
