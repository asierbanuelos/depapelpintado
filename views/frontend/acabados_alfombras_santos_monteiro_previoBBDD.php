...
$a_acabados[4][268]['BUREL 3 CM']['img']='/includes/images/acabados-santos-monteiro/burel.jpg';
$a_acabados[4][268]['BUREL 5 CM']['img']='/includes/images/acabados-santos-monteiro/burel.jpg';
$a_acabados[4][268]['BUREL 10 CM']['img']='/includes/images/acabados-santos-monteiro/burel.jpg';
$a_acabados[4][268]['COLORIST']['img']='/includes/images/acabados-santos-monteiro/color.jpg';
$a_acabados[4][268]['DOBRA Y FELTEX']['img']='/includes/images/acabados-santos-monteiro/dobra.jpg';
...
//$a_acabados[4][268]['FRESH']['img']='/includes/images/acabados-santos-monteiro/fresh.jpg'; // desaparece
$a_acabados[4][268]['LUX']['img']='/includes/images/acabados-santos-monteiro/lux.jpg';
$a_acabados[4][268]['REEF']['img']='/includes/images/acabados-santos-monteiro/reef.jpg';
...
$a_acabados[4][268]['COLORIST']['precio_m_lineal']=8.4;
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m_lineal']=9.6; // Mirar lo que hay que sumar por m2 por el fieltro
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m2_fieltro']=26.40; 
...
// 2025-01-17
// VOLVEMOS A CAMBIAR EL SISTEMA DE CÁLCULO DE FORMA QUE AHORA SE TENGAN EN CUENTA LOS ACABADOS POR METRO CUADRADO DE FORMA QUE QUITAMOS LOS METROS LINEALES
/*
$a_acabados[4][268]['SIN ACABADO']['precio_m_lineal']=0;
$a_acabados[4][268]['BAY']['precio_m_lineal']=10.95;
$a_acabados[4][268]['BUREL 3 CM']['precio_m_lineal']=10.95;
$a_acabados[4][268]['BUREL 5 CM']['precio_m_lineal']=10.95;
$a_acabados[4][268]['BUREL 10 CM']['precio_m_lineal']=10.95;
$a_acabados[4][268]['COLORIST']['precio_m_lineal']=7.5;
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m_lineal']=9; // Mirar lo que hay que sumar por m2 por el fieltro
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m2_fieltro']=15;//26.40; 
$a_acabados[4][268]['DUNE']['precio_m_lineal']=8.7;
$a_acabados[4][268]['EASY']['precio_m_lineal']=8.7;
$a_acabados[4][268]['JUST']['precio_m_lineal']=11;
$a_acabados[4][268]['LINE']['precio_m_lineal']=4.5;
$a_acabados[4][268]['VENEZA']['precio_m_lineal']=9.45;
$a_acabados[4][268]['FRANJA']['precio_m_lineal']=40.5;
//$a_acabados[4][268]['LINE COLORS']['precio_m_lineal']=6.6;
$a_acabados[4][268]['LINE COLORS']['precio_m_lineal']=5.25;//10.5;
//$a_acabados[4][268]['FRESH']['precio_m_lineal']=21.36; // DESAPARECE
$a_acabados[4][268]['LUX']['precio_m_lineal']=7.80;
$a_acabados[4][268]['TWILL']['precio_m_lineal']=10.20;

$extra_acabado_lineal[4][268]['LINE'][1816]=5; // La Stone contract (id 1816) sale 5 más cara el metro lineal en el acabado LINE
$extra_acabado_lineal[4][268]['LINE'][1817]=5; // La Stone  (id 1817) sale 5 más cara el metro lineal en el acabado LINE
$extra_acabado_lineal[4][268]['LINE'][1818]=5; // La Stone rustique (id 1818) sale 5 más cara el metro lineal en el acabado LINE
$extra_acabado_lineal[4][268]['LINE'][1819]=5; // La Stone colors (id 1819) sale 5 más cara el metro lineal en el acabado LINE
*/
// 2024-11-21 
// CAMBIAMOS EL MÉTIODO DE CALCULO, POR LO QUE LAS ALFOMBRAS SE VAN A CALCULAR EN BASE AL PRECIO DEL M2 + EL PERMÍMETRO LINEAL
// LOS CALCULOS DEL METRO CUADRADO DEL ACABADO NO HACEN FALTA
// 2025-01-17
// VOLVEMOS A CAMBIAR EL SISTEMA DE CÁLCULO DE FORMA QUE AHORA SE TENGAN EN CUENTA LOS ACABADOS POR METRO CUADRADO 
/*
// Precios del metro cuadrado a medida del acabado
$a_acabados[4][268]['BAY']['precio_m2_medida']=23.34; 
$a_acabados[4][268]['COLORIST']['precio_m2_medida']=19.6;
$a_acabados[4][268]['DUNE']['precio_m2_medida']=19.6;
$a_acabados[4][268]['EASY']['precio_m2_medida']=19.6;
$a_acabados[4][268]['VENEZA']['precio_m2_medida']=19.6;
$a_acabados[4][268]['JUST']['precio_m2_medida']=22.6;
...
//$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m2_medida']=49.1; // Mirar lo que hay que sumar por m2 por el feltex
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m2_medida']=58; // Mirar lo que hay que sumar por m2 por el feltex
...
- BUREL 10cm 97.04 €/m2
- COLORIST 17.13 €/m2
- DOBLA Y FELTEX 35.57 €/m2
- DUNE 17.13 €/m2
- EASY 17.13 €/m2
- FLEKOS 25 €/m2
- JUST 19.74 €/m2
- LINE 9.87 €/m2
- LINE COLORS 17.11 €/m2
- LUX 15.80 €/m2
- REEF 17.13 €/m2
- TWILL 19.32 €/m2
- VENEZA 17.13 €/m2
...
// Precios del metro cuadrado a medida del acabado
// Nuevos precios 2025
// Nuevos precios 2025-09
$a_acabados[4][268]['BAY']['precio_m2_medida']=21.29;// 20.41; 
$a_acabados[4][268]['BUREL 3 CM']['precio_m2_medida']=67.76;// 66.90;
$a_acabados[4][268]['BUREL 5 CM']['precio_m2_medida']=80.00;// 79.19;
$a_acabados[4][268]['BUREL 10 CM']['precio_m2_medida']=98.09;// 97.04;
$a_acabados[4][268]['COLORIST']['precio_m2_medida']=17.99;// 17.13;
$a_acabados[4][268]['DOBRA Y FELTEX']['precio_m2_medida']=37.71;// 35.57; // Mirar lo que hay que sumar por m2 por el feltex
$a_acabados[4][268]['DUNE']['precio_m2_medida']=17.99;// 17.13;
$a_acabados[4][268]['EASY']['precio_m2_medida']=17.99;// 17.13;
$a_acabados[4][268]['FRANJA']['precio_m2_medida']=25; 
$a_acabados[4][268]['JUST']['precio_m2_medida']=19.76;// 19.74;
$a_acabados[4][268]['LINE']['precio_m2_medida']=10.54;// 9.87;
$a_acabados[4][268]['LINE COLORS']['precio_m2_medida']=17.11;
$a_acabados[4][268]['LUX']['precio_m2_medida']=15.80;// 15.80;
$a_acabados[4][268]['REEF']['precio_m2_medida']=17.99;// 17.13;
$a_acabados[4][268]['TWILL']['precio_m2_medida']=20.18;// 19.32;
$a_acabados[4][268]['VENEZA']['precio_m2_medida']=17.99;// 17.13;

/*
Nuevos acabados
- DOBLA Y FELTEX DOTS 47.50;// 
- JUST Y FELTEX DOTS 34.39;// 
- LINE Y FELTEX DOTS 25.17;// 
*/

/*
$extra_coleccion[4][268][1938]['extra_precio_m2_medida']=12.12; // La coleccion Creek (id 1938) sale 12.12 más cara el metro cuadrado a medida para todos los acabados salvo LUX
$extra_coleccion[4][268][1948]['extra_precio_m2_medida']=12.72; // La coleccion Sisal Natura (id 1948) sale 12.72 más cara el metro cuadrado a medida para todos los acabados salvo LINE

$extra_acabado[4][268]['LINE'][1948]=15.53; // La Sisal Natura (id 1948) sale 15.53 más cara el metro cuadrado a medida en el acabado LINE
$extra_acabado[4][268]['LINE'][1821]=15.53; // La Sisal Maya (id 1821) sale 13 más cara el metro cuadrado a medida en el acabado LINE
...
$extra_acabado[4][268]['LINE'][1819]=11; // La Stone colors (id 1819) sale 11 más cara el metro cuadrado a medida en el acabado LINE

$extra_acabado[4][268]['LUX'][1938]=14.8; // La coleccion Creek (id 1938) sale 14.8 más cara el metro cuadrado a medida en el acabado LUX
$extra_acabado[4][268]['LUX'][1821]=12.72; // La Sisal Maya (id 1821) sale 12.72 más cara el metro cuadrado a medida en el acabado LUX

$extra_acabado[4][268]['DOBRA Y FELTEX'][1801]=12.38; // La BUGATI (id 1801) sale 12.38 más cara el metro cuadrado a medida en el acabado DOBRA
$extra_acabado[4][268]['DOBRA Y FELTEX'][1938]=64.4; // La Creek (id 1801) sale 64.4 más cara el metro cuadrado a medida en el acabado DOBRA

// Ya no se da esta diferencia de precio
//$precio_promo[4][268]['DOBRA Y FELTEX'][1803]=15.78; // La colceccion chenille (id 1803) está mucho más barata que el precio general DOBRA
*/

//$a_acabados[4][268]['PREMIUM']['precio_m_2']=40.8;

$a_acabados[4][268]['BAY']['opciones']='bay';
$a_acabados[4][268]['BUREL 3 CM']['opciones']='burel';
$a_acabados[4][268]['BUREL 5 CM']['opciones']='burel';
$a_acabados[4][268]['BUREL 10 CM']['opciones']='burel';
$a_acabados[4][268]['COLORIST']['opciones']='color';
...
$a_acabados[4][268]['REEF']['opciones']='reef';
$a_acabados[4][268]['TWILL']['opciones']='twill';

$a_acabados[4][268]['BAY']['txt_opciones']='ACABADO BAY';
$a_acabados[4][268]['BUREL 3 CM']['txt_opciones']='ACABADO BUREL 3 CM';
$a_acabados[4][268]['BUREL 5 CM']['txt_opciones']='ACABADO BUREL 5 CM';
$a_acabados[4][268]['BUREL 10 CM']['txt_opciones']='ACABADO BUREL 10 CM';
$a_acabados[4][268]['COLORIST']['txt_opciones']='ACABADO COLORIST';
...
$a_acabados[4][268]['REEF']['txt_opciones']='ACABADO REEF';
$a_acabados[4][268]['TWILL']['txt_opciones']='ACABADO TWILL';
...
$ocultar_acabado['COLORIST'][]=1803;// CHENILLE
...
$ocultar_acabado['DOBRA Y FELTEX'][]=1802;// CLASSIC
$ocultar_acabado['DOBRA Y FELTEX'][]=1793;// GLAMOUR
$ocultar_acabado['DOBRA Y FELTEX'][]=1810;// KILT
$ocultar_acabado['DOBRA Y FELTEX'][]=1822;// SISAL BALL
$ocultar_acabado['DOBRA Y FELTEX'][]=1821;// SISAL MAYA
$ocultar_acabado['DOBRA Y FELTEX'][]=1823;// SISAL TERRACOTE
$ocultar_acabado['DOBRA Y FELTEX'][]=1833;// WOOLLY II


$ocultar_acabado['BUREL 3 CM'][]=1803;// CHENILLE
$ocultar_acabado['BUREL 3 CM'][]=1938;// CREEK
$ocultar_acabado['BUREL 3 CM'][]=1940;// MATTE
$ocultar_acabado['BUREL 3 CM'][]=1810;// KILT
$ocultar_acabado['BUREL 3 CM'][]=1795;// KASA
$ocultar_acabado['BUREL 3 CM'][]=1822;// SISAL BALL
$ocultar_acabado['BUREL 3 CM'][]=1821;// SISAL MAYA
$ocultar_acabado['BUREL 3 CM'][]=1823;// SISAL TERRACOTE
$ocultar_acabado['BUREL 3 CM'][]=1790;// SEDUCTION
$ocultar_acabado['BUREL 3 CM'][]=1791;// REFLEX
$ocultar_acabado['BUREL 3 CM'][]=1812;// PALMA
$ocultar_acabado['BUREL 3 CM'][]=1811;// OPULENT

$ocultar_acabado['BUREL 5 CM'][]=1803;// CHENILLE
$ocultar_acabado['BUREL 5 CM'][]=1938;// CREEK
$ocultar_acabado['BUREL 5 CM'][]=1940;// MATTE
$ocultar_acabado['BUREL 5 CM'][]=1810;// KILT
$ocultar_acabado['BUREL 5 CM'][]=1795;// KASA
$ocultar_acabado['BUREL 5 CM'][]=1822;// SISAL BALL
$ocultar_acabado['BUREL 5 CM'][]=1821;// SISAL MAYA
$ocultar_acabado['BUREL 5 CM'][]=1823;// SISAL TERRACOTE
$ocultar_acabado['BUREL 5 CM'][]=1790;// SEDUCTION
$ocultar_acabado['BUREL 5 CM'][]=1791;// REFLEX
$ocultar_acabado['BUREL 5 CM'][]=1812;// PALMA
$ocultar_acabado['BUREL 5 CM'][]=1811;// OPULENT

$ocultar_acabado['BUREL 10 CM'][]=1803;// CHENILLE
$ocultar_acabado['BUREL 10 CM'][]=1938;// CREEK
$ocultar_acabado['BUREL 10 CM'][]=1940;// MATTE
$ocultar_acabado['BUREL 10 CM'][]=1810;// KILT
$ocultar_acabado['BUREL 10 CM'][]=1795;// KASA
$ocultar_acabado['BUREL 10 CM'][]=1822;// SISAL BALL
$ocultar_acabado['BUREL 10 CM'][]=1821;// SISAL MAYA
$ocultar_acabado['BUREL 10 CM'][]=1823;// SISAL TERRACOTE
$ocultar_acabado['BUREL 10 CM'][]=1790;// SEDUCTION
$ocultar_acabado['BUREL 10 CM'][]=1791;// REFLEX
$ocultar_acabado['BUREL 10 CM'][]=1812;// PALMA
$ocultar_acabado['BUREL 10 CM'][]=1811;// OPULENT
...
foreach ($a_acabados[4][268] as $txt_acabado=>$datos_acabado){
	if (!isset($ocultar_acabado[$txt_acabado]) || !in_array($key['item_coleccion_id'], $ocultar_acabado[$txt_acabado])){
		...
		if ($txt_acabado=='FRANJA' && isset($a_acabados[4][268]['LINE']['precio_m_lineal']))
...
function calcularSantosMonteiro(){
	...
	if (faltan_datos){
        ...
        console.log("metros_pieza_exactos: "+metros_pieza_exactos);
        console.log("precio m2 sin acabado: "+preciobase +' --> '+preciounitario);
        console.log("precio alfombra sin acabado: "+precio_alfombra_original_a_medida.toFixed(2) +' --> '+precio_alfombra_final_a_medida.toFixed(2));
        ...
        console.log("precio alfombra con acabado: "+precio_alfombra_original_a_medida.toFixed(2) +' --> '+precio_alfombra_final_a_medida.toFixed(2));
