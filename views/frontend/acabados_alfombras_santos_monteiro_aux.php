		...
		<div id='dimensiones_rollo' class="row d-none" >
			...
			<div class="col-6">
				<div class="pr-15">
				  ...
				  <div class="">
				    <div class="mt-2">
						<input type="radio" id="val_2" name="ancho_rollo" value="2" onclick="calcularSantosMonteiro();" />
						<label for="val_2" class="mr-4">2 metros</label>
						<input type="radio" id="val_4" name="ancho_rollo" value="4" onclick="calcularSantosMonteiro();" />
...
function calcularSantosMonteiro(){
	...
	if (faltan_datos){
	    ...
	    precio_m_2_extra= $("#calc_precio_extra").val();
	    precio_m_2_promo= $("#calc_precio_promo").val();
	    precio_m_lineal= $("#calc_precio_m_lineal").val();
	    precio_m_lineal_largo= $("#calc_precio_m_lineal_largo").val();
	    precio_m_2_fieltro= $("#calc_precio_m2_fieltro").val();
		...
		*/
        ...
        console.log("precio final rollo ( "+p_ancho+" x "+p_alto+" ): "+precio_alfombra_final_rollo.toFixed(2));
        console.log("precio final rollo ( "+p_alto+" x "+p_ancho+" ): "+precio_alfombra_final_rollo_2.toFixed(2));
