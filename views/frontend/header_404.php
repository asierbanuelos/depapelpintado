<?php
if (isset($articulo_no_encontrado)){
...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="es" class="no-js"><!--<![endif]-->
	...
	*/
	...
	<script src="<?php echo $includes_dir; ?>nivo-slider/jquery.nivo.slider.js"></script>
	<script src="<?php echo $includes_dir; ?>js/jquery-ui.min.js"></script>
	<script src="<?php echo $includes_dir; ?>js/shadowbox/shadowbox.js"></script>
  ...
  <link rel="stylesheet" href="<?=$includes_dir?>js/shadowbox/shadowbox.css">
	<link rel="stylesheet" href="<?=$includes_dir?>js/zoomy.css">
	<link rel="stylesheet" href="<?=$includes_dir?>js/jquery-ui.min.css">
	...
	<link rel="stylesheet" href="<?=$includes_dir?>nivo-slider/themes/default/default.css" type="text/css" media="screen" />
	<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
	<link rel="stylesheet" href="<?=$includes_dir?>nivo-slider/nivo-slider.css">
  ...
  */
  ?>
    ...
    <div class="units-row gris-oscurobg end barrasuperior">
      ...
      <div class="unit-50 end">
        ...
        <div class="units-row end">
          ...
          <nav>
          <ul class="minimenu1">
         <li> <?=anchor("",'<img src="'.$includes_dir.'images/home.png" alt="Home - Inicio" title="Home - Inicio" />');?></li>
         <li> <?=anchor("contacto",'<img src="'.$includes_dir.'images/contacto.png"  alt="Contacto" title="Contacto">');?></li>
	...
	<div class="unit-60">
      ...
      <div id="panel-l">
        <div id="panelCaller"><img src="<?php echo base_url('includes/images/fblogo.png');?>" alt='facebook' title='facebook' /></div>
<div class="fb-page" data-href="https://www.facebook.com/depapelpintado" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/depapelpintado"><a href="https://www.facebook.com/depapelpintado">depapelpintado.es</a></blockquote></div></div>
      ...
      <div class="unit-50">
        ...
        <ul class="minimenu1">
         ...
         <li> <a href="https://www.facebook.com/pages/depapelpintadoes/841339525924852" target="_blank"><img src="<?=$includes_dir?>images/facebook.jpg"  alt="Búscanos en Facebook" title="Búscanos en Facebook" ></a></li>
         <li> <a href="https://twitter.com/EKAMDecoracion" target="_blank"><img src="<?=$includes_dir?>images/twitter.jpg"  alt="Síguenos en Twitter" title="Síguenos en Twitter" ></a></li>
         <?php
         /*
         ...
         */
         ?>
         <li> <a href="https://instagram.com/depapelpintado.es/" target="_blank"><img src="<?=$includes_dir?>images/instagram.jpg"  alt="Síguenos en Instagram" title="Síguenos en Instagram" ></a></li>
         <li> <a href="https://es.pinterest.com/depapelpintado/" target="_blank"><img src="<?=$includes_dir?>images/pinterest.jpg"  alt="Síguenos en Pinterest" title="Síguenos en Pinterest" ></a></li>
          </ul>  
