...
$enlace_carrito='/tienda/carrito';

?>
<div id="mini_cart_movil" class="right minicarro errro text-right d-inline-flex">
  <div style="display:inline">
    <?php 
    if (!isset($ocultar_enlace)){
      ?>
      <a href="/tienda/carrito" style="width:100%;" aria-label="<?php echo $this->$flexi_cart_library->total(); ?> - Ver carrito">
        <span style="width:100%;" class="cartdisplay">
          <span class="precio-minicarro sombra" id='precio_minicarro_movil'>
            ...
            <span class="cart-icon-wrap">
              ...
              <?php $total_items_badge = (int) $this->$flexi_cart_library->total_items(false); if ($total_items_badge > 0): ?>
                <span class="cart-badge"><?php echo $total_items_badge; ?></span>
              <?php endif; ?>
            </span>
          </span>
        </span>
  ...
  <div class="ulcarro dropdown-carrito" id='capa-mini-carro_movil' style='display:none;'>
    <?php 
