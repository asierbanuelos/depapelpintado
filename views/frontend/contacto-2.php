    ...
    <div class="row">
      <div id="left-column" class="col-xs-12 col-sm-4 col-md-4">
          ...
          */
          ...
          <?php 
          /*
          2024-12-17 Ocultamos el mapa
          2025-05-30 Lo volvemos a mostrar
          */
          ?>
          <div class="mapouter">
      ...
      <div id="content-wrapper" class=" left-column col-xs-12 col-sm-12 col-md-8 col-lg-8 contact-form">
        <section class="">
          ...
          <form action="/contacto" method="post" id='kontaktu-formularioa' enctype="multipart/form-data">
            <section class="form-fields mt-4">
              <div class='row'>
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-md-3 form-control-label" for="i-tema">Tema</label>
                    <div class="col-md-9">
                      <select name="i-tema" id="i-tema" class="form-control" >
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-md-3 form-control-label" for="i-name">Nombre</label>
                    <div class="col-md-9">
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-md-3 form-control-label" for="i-email">Correo</label>
                    <div class="col-md-9">
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <input id="file-upload" type="file" name="fileUpload" class="filestyle" data-buttontext="Elija el archivo" tabindex="-1" style="position: absolute; clip: rect(0px, 0px, 0px, 0px);">
                      <div class="bootstrap-filestyle input-group">
                        <input id='txt_archivo_seleccionado' type="text" class="form-control " placeholder="" disabled=""> 
                        <span class="group-span-filestyle input-group-btn" tabindex="0">
                          <label for="file-upload" class="boton-opciones m-0" style="line-height: 26px;">
                            <span class="icon-span-filestyle glyphicon glyphicon-folder-open"></span> 
                            <span class="buttonText">Elija el archivo</span>
                          </label>
                        </span>
                      </div>
                    </div>   
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    <label class="col-md-3 form-control-label" for="validatedCustomFile">Archivo adjunto</label>
                    <div class="col-md-9">
                      <div>
                ...
                */
                ...
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      <textarea id="message" class="form-control" name="message" placeholder="¿Cómo podemos ayudar?" rows="5"><?php echo $txt_consulta; ?></textarea>
                    </div>
                  </div>
                </div>
              </div>
