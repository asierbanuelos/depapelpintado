        ...
        <div class="container">
            <div class="row align-items-top pagina-info-texto-small">
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <div><a href="tel:+34944056616" target="_blank"><i class="fa fa-phone" aria-hidden="true"></i> <span>94 405 66 16</span></a></div>
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    ...
                    <ul class="menu-footer2">
                        ...
                        <li><?=anchor("tienda/fotomurales","Fotomurales");?></li>
