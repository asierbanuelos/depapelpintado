...
$a_acabados[4][276]['SIN ACABADO']['img']='/includes/images/acabados/sin-remate.jpg';
$a_acabados[4][276]['MINI FEST']['img']='/includes/images/acabados/mini-fest.jpg';
$a_acabados[4][276]['SUPER FEST']['img']='/includes/images/acabados/super-fest.jpg';
$a_acabados[4][276]['STRONG']['img']='/includes/images/acabados/strong.jpg';
$a_acabados[4][276]['ANTELOOK-BANDA']['img']='/includes/images/acabados/antelook-banda.jpg';
$a_acabados[4][276]['ANTELOOK-BLIND']['img']='/includes/images/acabados/antelook-blind.jpg';
$a_acabados[4][276]['PREMIUM']['img']='/includes/images/acabados/premium.jpg';
$a_acabados[4][276]['PREMIUM ULTRA']['img']='/includes/images/acabados/premium-ultra.jpg';
$a_acabados[4][276]['BANDA NATUR']['img']='/includes/images/acabados/banda-natur.jpg';
$a_acabados[4][276]['THE END']['img']='/includes/images/acabados/the-end.jpg';
$a_acabados[4][276]['MICROFIBRA 6 CM']['img']='/includes/images/acabados/microfibra-6cm.jpg';
$a_acabados[4][276]['MICROFIBRA 12CM']['img']='/includes/images/acabados/microfibra-12cm.jpg';
$a_acabados[4][276]['PIEL VUELTA 2 CM']['img']='/includes/images/acabados/piel-vuelta-2cm.jpg';
$a_acabados[4][276]['PIEL VUELTA 6 CM']['img']='/includes/images/acabados/piel-vuelta-6cm.jpg';
$a_acabados[4][276]['PIEL VUELTA 12 CM']['img']='/includes/images/acabados/piel-vuelta-12cm.jpg';
$a_acabados[4][276]['KUERO 6 CM']['img']='/includes/images/acabados/kuero-6cm.jpg';
$a_acabados[4][276]['KUERO 12 CM']['img']='/includes/images/acabados/kuero-12cm.jpg';
$a_acabados[4][276]['BANDA SINGLE']['img']='/includes/images/acabados/banda-single.jpg';
$a_acabados[4][276]['FLECOS']['img']='/includes/images/acabados/flecos.jpg';


$a_acabados[4][276]['SIN ACABADO']['precio_m_lineal']=0;
$a_acabados[4][276]['MINI FEST']['precio_m_lineal']=13;
$a_acabados[4][276]['SUPER FEST']['precio_m_lineal']=13;
$a_acabados[4][276]['STRONG']['precio_m_lineal']=11.8;
$a_acabados[4][276]['ANTELOOK-BANDA']['precio_m_lineal']=11;
$a_acabados[4][276]['ANTELOOK-BLIND']['precio_m_lineal']=12;
$a_acabados[4][276]['PREMIUM']['precio_m_2']=40.8;
$a_acabados[4][276]['PREMIUM ULTRA']['precio_m_2']=45.6;
$a_acabados[4][276]['BANDA NATUR']['precio_m_lineal']=11.2;
$a_acabados[4][276]['THE END']['precio_m_lineal']=9.5;
$a_acabados[4][276]['MICROFIBRA 6 CM']['precio_m_lineal']=13;
$a_acabados[4][276]['MICROFIBRA 12CM']['precio_m_lineal']=27;
$a_acabados[4][276]['PIEL VUELTA 2 CM']['precio_m_lineal']=26.4;
$a_acabados[4][276]['PIEL VUELTA 6 CM']['precio_m_lineal']=48;
$a_acabados[4][276]['PIEL VUELTA 12 CM']['precio_m_lineal']=76.8;
$a_acabados[4][276]['KUERO 6 CM']['precio_m_lineal']=62.4;
$a_acabados[4][276]['KUERO 12 CM']['precio_m_lineal']=76.8;
$a_acabados[4][276]['BANDA SINGLE']['precio_m_lineal']=9.5;
$a_acabados[4][276]['FLECOS']['precio_m_lineal']=20.4;

$a_acabados[4][276]['MINI FEST']['opciones']='fest';
$a_acabados[4][276]['SUPER FEST']['opciones']='fest';
$a_acabados[4][276]['STRONG']['opciones']='strong';
$a_acabados[4][276]['ANTELOOK-BANDA']['opciones']='antelook';
$a_acabados[4][276]['ANTELOOK-BLIND']['opciones']='antelook';
$a_acabados[4][276]['BANDA NATUR']['opciones']='banda-natur';
$a_acabados[4][276]['THE END']['opciones']='banda-the-end';
$a_acabados[4][276]['MICROFIBRA 6 CM']['opciones']='banda-microfibra';
$a_acabados[4][276]['MICROFIBRA 12CM']['opciones']='banda-microfibra';
$a_acabados[4][276]['PIEL VUELTA 2 CM']['opciones']='banda-piel-vuelta';
$a_acabados[4][276]['PIEL VUELTA 6 CM']['opciones']='banda-piel-vuelta';
$a_acabados[4][276]['PIEL VUELTA 12 CM']['opciones']='banda-piel-vuelta';
$a_acabados[4][276]['KUERO 6 CM']['opciones']='banda-kuero';
$a_acabados[4][276]['KUERO 12 CM']['opciones']='banda-kuero';
$a_acabados[4][276]['BANDA SINGLE']['opciones']='banda-single';
$a_acabados[4][276]['FLECOS']['opciones']='flecos';

$a_acabados[4][276]['MINI FEST']['txt_opciones']='RIBETE FEST';
$a_acabados[4][276]['SUPER FEST']['txt_opciones']='RIBETE FEST';
$a_acabados[4][276]['STRONG']['txt_opciones']='BANDA STRONG';
$a_acabados[4][276]['ANTELOOK-BANDA']['txt_opciones']='ANTELOOK';
$a_acabados[4][276]['ANTELOOK-BLIND']['txt_opciones']='ANTELOOK';
$a_acabados[4][276]['BANDA NATUR']['txt_opciones']='BANDA NATUR';
$a_acabados[4][276]['THE END']['txt_opciones']='BANDA THE END';
$a_acabados[4][276]['MICROFIBRA 6 CM']['txt_opciones']='BANDA MICROFIBRA 6 CM';
$a_acabados[4][276]['MICROFIBRA 12CM']['txt_opciones']='BANDA MICROFIBRA 12 CM';
$a_acabados[4][276]['PIEL VUELTA 2 CM']['txt_opciones']='BANDA PIEL VUELTA 2 CM';
$a_acabados[4][276]['PIEL VUELTA 6 CM']['txt_opciones']='BANDA PIEL VUELTA 6 CM';
$a_acabados[4][276]['PIEL VUELTA 12 CM']['txt_opciones']='BANDA PIEL VUELTA 12 CM';
$a_acabados[4][276]['KUERO 6 CM']['txt_opciones']='BANDA KUERO 6 CM';
$a_acabados[4][276]['KUERO 12 CM']['txt_opciones']='BANDA KUERO 12 CM';
$a_acabados[4][276]['BANDA SINGLE']['txt_opciones']='BANDA SINGLE';
$a_acabados[4][276]['FLECOS']['txt_opciones']='REMATE FLEKOS';
...
function calcularKP(){
	...
	if (faltan_datos){
		...
		metros_pieza=0;
		precio_alfombra_original=0;
		precio_alfombra_final=0;
		if(p_ancho<=4){
			if (p_ancho>2)
		    ...
		    if ($("#acabado_seleccionado").text()=='FLECOS' && $(".txt-tipo-seleccionado").text()=='EN EL ANCHO' && lado_corto>0){
		        console.log("Flecos lado corto");
		    	// Si acabado es franja, no se aplica a todo el perímetro, solo al lado corto. Lado largo, THE END
		        ...
		        console.log("precio_alfombra_original: "+ (metros_pieza*preciobase));
		        console.log("lado corto: "+ (lado_corto*2*precio_m_lineal));
		        console.log("precio lado largo: "+ precio_m_lineal_largo);
		...
		metros_pieza_2=0;
		precio_alfombra_original_2=0;
		precio_alfombra_final_2=0;
		if(p_alto<=4){
			if (p_alto>2)
		    ...
		    if ($("#acabado_seleccionado").text()=='FRANJA' && lado_corto>0){
		        ...
		        console.log("precio_alfombra_original 2: "+ (metros_pieza_2*preciobase));
		        console.log("lado corto: "+ (lado_corto*2*precio_m_lineal));
		        console.log("precio lado largo: "+ precio_m_lineal_largo);
		        console.log("lado largo: "+ (lado_largo*2*precio_m_lineal_largo));
			...
			if (metodo_descuento==1){
		        ...
		        console.log("valor_descuento: "+ valor_descuento);
		        console.log("precio final descuento 2: "+ precio_alfombra_final_2);
			}
		}
