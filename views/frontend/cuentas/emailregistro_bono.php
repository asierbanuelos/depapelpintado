...
<html>
	<head>
		...
		<title>¡Bienvenid@ a dePapelPintado!</title>
				...
				<table class="table" bgcolor="#ffffff" style="width:100%">
					...
					<tr>
						<td align="center" class="titleblock" style="padding:7px 0">
							...
							<h1>¡Bienvenid@ a <span style="color:#a36185">dePapelPintado</span>!</h1>
							<?php 
							/*
							<p><strong>Te damos la bienvenida a nuestra Newsletter.</strong></p>
							*/
							?>
