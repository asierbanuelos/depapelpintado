...
<table class="caja100">
<tr>
<td class="facturatitulo" colspan="3">
<h1>&nbsp;</h1>
</td>
</tr>
<tr>
...
<a href="http://www.depapelpintado.es" title="depapelpintado.es">www.depapelpintado.es</a> </p>
</td>
<td class="logo2">
...
Cliente: <?php echo $summary_data['ord_demo_ship_name']." (".$summary_data['ord_demo_phone'].")";?><br/>

Domicilio: <?php echo $summary_data['ord_demo_ship_address_01'];?><br/>
Ciudad: <?php echo $summary_data['ord_demo_ship_city'];?><br/>
C.P.: <?php echo $summary_data['ord_demo_ship_post_code'];?><br/>

</td>
<td style="width:200px">

Página: 1<br/>
Ticket: <? echo str_pad($summary_data['factura2'], 5, 0, STR_PAD_LEFT);?><br/>
Fecha: <? echo $summary_data['fechafactura'];?><br/>
...
<tr>
<td>
<table class="borde-gral" cellspacing="0" cellpadding="0">
  <col width="89">
  <col width="52">
  <col width="85">
  <col width="68">
  ...
  <tr class="borde-bottom fondocelda">
    <td colspan="2" class="borde-right">Por Mediación de:</td>
    <td colspan="3" class="borde-right">N.-Albarán</td>
    <td colspan="4">Dirección de Envío:</td>
  </tr>
  <tr class="borde-bottom">
    <td colspan="2" class="borde-right">Online</td>
    <td colspan="3" class="borde-right"><?php echo $summary_data[$this->flexi_cart_admin->db_column('order_summary', 'order_number')];?></td>
  ...
  <tr class="borde-bottom fondocelda">
    <td class="borde-right">Referencia</td>
    <td class="borde-right" colspan="4">Concepto</td>
    <td class="borde-right">Cantidad</td>
    <td class="borde-right">Precio</td>
  ...
  ?>
  <tr>
    <td class="borde-right"><?=$row[$this->flexi_cart_admin->db_column('order_details', 'id')]?></td>
    <td colspan="4" class="borde-right"><?=$row[$this->flexi_cart_admin->db_column('order_details', 'item_name')]?>
<?php 
...
<?php }?>
    ...
    <td width="73" class="borde-right"><?=round($row[$this->flexi_cart_admin->db_column('order_details', 'item_quantity')], 2)?></td>
  ...
  <tr>
    ...
    <td colspan="4" class="borde-right">&nbsp;</td>
    <td width="73" class="borde-right">&nbsp;</td>
    <td class="borde-right">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <?}
...
<tr>
    <td class="borde-right">&nbsp;</td>
    <td colspan="4" class="borde-right">
<?php echo $summary_data[$this->flexi_cart_admin->db_column('order_summary', 'reward_voucher_description')];?>
  ...
  <tr class="fondocelda">
    <td class="borde-right">Total Bruto:</td>
    <td class="borde-right">%</td>
    <td class="borde-right">Importe dto.</td>
    <td class="borde-right">Portes</td>
    <td class="borde-right">Base Imponible</td>
    <td class="borde-right">21% IVA</td>
    <td class="borde-right">Subtotal</td>
  ...
  <tr>
    <td class="borde-right"><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'item_summary_total')]+$summary_data[$this->flexi_cart_admin->db_column('order_summary', 'item_summary_savings_total')], TRUE, 2, TRUE);?></td>
   <td class="borde-right">&nbsp;</td>
    <td class="borde-right"><?php if ($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'summary_savings_total')]+$summary_data[$this->flexi_cart_admin->db_column('order_summary', 'item_summary_savings_total')] > 0)echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'item_summary_savings_total')]+$summary_data[$this->flexi_cart_admin->db_column('order_summary', 'summary_savings_total')], TRUE, 2, TRUE);?></td>
    <td class="borde-right"><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'shipping_total')], TRUE, 2, TRUE);?></td>
    <td class="borde-right"><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'total')]-$summary_data[$this->flexi_cart_admin->db_column('order_summary', 'tax_total')], TRUE, 2, TRUE);?></td>
    <td class="borde-right"><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'tax_total')], TRUE, 2, TRUE);?></td>
...
<table cellspacing="0" cellpadding="0" class="borde-gral">
  ...
  <tr>
    ...
    <td colspan="5"><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'total')], TRUE, 2, TRUE);?></td>
  </tr>
</table>
...
<p style="font-size:10px;margin:0;" class="datospie1">
	...
	<br />
	Ud. puede ejercitar sus derechos de acceso, rectificación, cancelación y oposición, mediante petición escrita dirigida a EDKAR & ALPER S.L. 
</p>
<p style="font-size:10px;margin:0;" class="datospie2">
	...
	web: <a href="http://www.ekamdecoracion.com" title="www.ekamdecoracion.com">www.ekamdecoracion.com</a><br>
	CIF B95690749
</p>
