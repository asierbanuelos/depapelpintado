	...
	<!-- Main Content -->
		<div class="clearfix">
			<div id="cart_content">
            	...
            	<button onclick="javascript:location.href='https://www.depapelpintado.es/'" type="button" name="update" value="Volver a la tienda" class="link_button2">Volver a la tienda <i class="fa fa-desktop"></i></button>
...
<?}?>
        ...
        <div style="display:block;height: 75px;"></div>
				...
				?>
					...
					<script>alert('<?php echo strip_tags(str_replace(array("'", "\n", "\r"), array("\\'", " ", " "), $message)); ?>');</script>
				<?php
				}
				/*
				if (isset($_GET['test'])){
					...
					<?php if (isset($countries)) { ?>
						<table id="cart_shipping">
							<thead>
								<tr>
									<td colspan="5">
										<div style="font-size: 16px;float:left;"><a href="https://www.depapelpintado.es/tienda/herramientas"><img src="https://www.depapelpintado.es/includes/cola.jpg" width="100px"></a></div><div style="font-size: 16px; padding-top:40px; float:left;">! No se olvide de la cola ! . Pase por la sección de <a href="https://www.depapelpintado.es/tienda/herramientas">herramientas</a> y complemente su compra.</span></div>
									</td>
								</tr>
								<tr>
									<th>Envio</th>
							...
							<tbody>
								...
								<tr  >
									<td>
										<label class="spacer_250">País:
											<select id="country_id" name="shipping[country]">
								...
								<tr>
									<td>
										...
										<select id="opcion_envio" name="shipping[db_option]">
...
$(document).ready(function() {
    ...
    var c= confirm("¿Seguro que quiere eliminar este artículo?");
    if(c==true){
      
      nombre_completo=$(this).attr('data-nombre-completo');
      id_producto=$(this).attr('data-id-producto');
      precioart=$(this).attr('data-precio');
      marca=$(this).attr('data-fab');
      tipo_producto=$(this).attr('data-tipo-producto');
      unidades=$(this).attr('data-unidades');
