		...
		<?php } ?>
			...
			<?php echo form_open(current_url());?>						
				...
				<fieldset class="w50">
					...
					<table>
						<tr><td style='width:30%'><span class="spacer_125">Nombre: </span></td><td><input style='margin:0;width:100%;' type='text' name='ord_demo_bill_name' value='<?php echo $summary_data['ord_demo_bill_name'];?>' /></td></tr>
						<tr><td><span class="spacer_125">CIF: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_bill_company' value='<?php echo $summary_data['ord_demo_bill_company'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Dirección 01: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_bill_address_01' value='<?php echo $summary_data['ord_demo_bill_address_01'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Población: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_bill_city' value='<?php echo $summary_data['ord_demo_bill_city'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Provincia: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_bill_state' value='<?php echo $summary_data['ord_demo_bill_state'];?>' /></td></tr>
						<tr><td><span class="spacer_125">CP: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_bill_post_code' value='<?php echo $summary_data['ord_demo_bill_post_code'];?>' /></td></tr>
						<tr><td><span class="spacer_125"> &nbsp;</span></td><td><input type="submit" name="actualizar_facturacion" value="Actualizar datos de facturación" class="link_button large"/></td></tr>
					</table>
					<?php
					/*
					<ul>
				...
				<fieldset class="w50 r_margin">
					...
					<table>
						<tr><td style='width:30%'><span class="spacer_125">Nombre: </span></td><td><input style='margin:0;width:100%;' type='text' name='ord_demo_ship_name' value='<?php echo $summary_data['ord_demo_ship_name'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Dirección 01: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_ship_address_01' value='<?php echo $summary_data['ord_demo_ship_address_01'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Población: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_ship_city' value='<?php echo $summary_data['ord_demo_ship_city'];?>' /></td></tr>
						<tr><td><span class="spacer_125">Provincia: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_ship_state' value='<?php echo $summary_data['ord_demo_ship_state'];?>' /></td></tr>
						<tr><td><span class="spacer_125">CP: </span></td><td><input style='margin:0;width:100%;'  type='text' name='ord_demo_ship_post_code' value='<?php echo $summary_data['ord_demo_ship_post_code'];?>' /></td></tr>
						<tr><td><span class="spacer_125"> &nbsp;</span></td><td><input type="submit" name="actualizar_envio" value="Actualizar datos de envío" class="link_button large"/></td></tr>
					</table>
					<?php
					/*
					<ul>
				...
				<div class="parallel" style='clear:both;'>
				...
				<fieldset>
						...
						?>
							<tr>
								<td>
									...
									<!-- Item Name -->
									<?php 
									echo $row[$this->flexi_cart_admin->db_column('order_details', 'item_name')];
								...
								<?php 
									...
									if ($row[$this->flexi_cart_admin->db_column('order_details', 'item_discount_quantity')] > 0) 
									{
										...
										else
										{
											...
											echo number_format($row[$this->flexi_cart_admin->db_column('order_details', 'item_non_discount_quantity')]).' x '.
												$this->flexi_cart_admin->format_currency($row[$this->flexi_cart_admin->db_column('order_details', 'item_price')], TRUE, 2, TRUE).'<br/>';
										}
										...
										if ($row[$this->flexi_cart_admin->db_column('order_details', 'item_discount_quantity')] > 0)
										{
											...
											echo number_format($row[$this->flexi_cart_admin->db_column('order_details', 'item_discount_quantity')]).' x '.
												$this->flexi_cart_admin->format_currency($row[$this->flexi_cart_admin->db_column('order_details', 'item_discount_price')], TRUE, 2, TRUE);
										}
									}
								...
								<td class="align_ctr">
									<?php 
									echo round($row[$this->flexi_cart_admin->db_column('order_details', 'item_quantity')], 2); 
									/*
									$cantidad_pedida=round($row[$this->flexi_cart_admin->db_column('order_details', 'item_quantity')], 2); 
									<input type="text" name="update_details[<?php echo $order_detail_id;?>][quantity]" value="<?echo $cantidad_pedida; ?>" size='3' />
									*/
									?>
								</td>
								<td class="align_ctr">
					...
					?>                                      
						...
						//~ print '</xmp></pre>';
						if  ($summary_data['factura']!=0){
							echo '<input type="submit" name="factura_rectificativa" value="Factura Rectificativa" class="link_button large"/> ';
						}
					}
