	...
	<div class="container">
		...
		<?php } ?>
			...
			<?php echo form_open(current_url());?>						
				<h1><?php echo ($discount_type == 'item') ? 'Artículo' : 'Resumen';?> Descuentos</h1>
				<p>
				<?php if ($discount_type == 'summary') { ?>
					<a href="<?php echo $base_url; ?>admin_library/item_discounts">Administrar descuentos por artículo</a> | 
				<?php } else { ?>
					<a href="<?php echo $base_url; ?>admin_library/summary_discounts">Administrar descuentos por pedido</a> | 
				<?php } ?>
					<a href="<?php echo $base_url; ?>admin_library/insert_discount">Añadir Descuento</a>
				</p>
					...
					<tbody>
						<tr>
							<td colspan="7">
								...
								<a href="<?php echo $base_url; ?>admin_library/insert_discount">Añadir nuevo descuento</a>
							</td>
						</tr>
					</tbody>
				<?php } ?>
