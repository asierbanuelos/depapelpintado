...
<body>
  ...
  <div id="editform" style="position:fixed;top:0;width:100%;height:100%;z-index: 100;background-color:rgba(0,0,0,0.6);padding:20px;display:none;">
    ...
    <div class="sec row"><div class="col two t-six m-six">COLOR:</div><?=  form_input("name","",'class="two t-six m-six iname"')?>
      <div class="col one t-six m-six">Categorias:</div>
              <div class="col ten t-six m-six"><?= form_multiselect('cats[]', array("Papel Pintado"=>"Papel Pintado","Foto Murales"=>"Foto Murales","Revestimientos"=>"Revestimientos","Telas"=>"Telas","Alfombras"=>"Alfombras")) ?></div>
</div>
<div class="sec row">
  ...
  <div class="container">
    ...
    <div class="sec row"><div class="col six t-six m-six" style="text-align: right;padding: 3px 10px 0px 0px;">COLOR: <?=  form_input("name","",'class="two t-six m-six"')?></div>
     <div class="col one t-six m-six">Categorias:</div>
     ...
     <div class="sec row">
    <?=form_submit("test", "Guardar",'class="button orange-button twelve t-full m-full send"')?></div>
    <?=form_close();?> 
    <div style="height: 40px"></div>
...
<?foreach ($colores as $key) {?>
     <div class="sec row">
       ...
       <div class="col eight cname" style="text-align:center;padding-top: 15px;">
         <?=$key->gama_name?>
       </div>
