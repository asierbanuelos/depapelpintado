			...
			<?php echo form_open(current_url());?>						
				...
				<fieldset class="w50">
					...
					<ul>
						...
						<li><span class="spacer_125">Dirección 02: </span><?php echo $summary_data['ord_demo_bill_address_02'];?></li>
						...
						<li><span class="spacer_125">Pais: </span><?php echo $summary_data['ord_demo_bill_country'];?></li>
					</ul>
				</fieldset>
				<fieldset class="w50 r_margin">
					...
					<ul>
						...
						<li><span class="spacer_125">Dirección 02: </span><?php echo $summary_data['ord_demo_ship_address_02'];?></li>
						...
						<li><span class="spacer_125">Pais: </span><?php echo $summary_data['ord_demo_ship_country'];?></li>
					</ul>
				</fieldset>
