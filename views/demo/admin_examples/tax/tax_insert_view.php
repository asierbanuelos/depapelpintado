	...
	<div class="container">
		...
		<?php } ?>
			...
			<?php echo form_open(current_url());?>
				<h1>Añadir Nuevo Impuesto</h1>
				<p><a href="<?php echo $base_url; ?>admin_library/tax">Administrar Impuestos</a></p>
				
				<table>
					<thead>
						<tr>
							<th class="info_req tooltip_trigger"
								title="<strong>Requeridod</strong><br/> Nombre del Impuesto.">
								Nombre
							</th>
					...
					<tfoot>
						<tr>
							<td colspan="6">
								<input type="submit" name="insert_tax" value="Añadir Nuevo Impuesto" class="link_button large"/>
							</td>
						</tr>
					</tbody>
				</table>
