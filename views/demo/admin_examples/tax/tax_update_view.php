	...
	<div class="container">
		...
		<?php } ?>
			...
			<?php echo form_open(current_url());?>
				...
				<p><a href="<?php echo $base_url; ?>admin_library/insert_tax">Añadir Nuevo Impuesto</a></p>
				
				<table>
					<thead>
						<tr>
							<th class="info_req tooltip_trigger"
								title="<strong>Requerido</strong><br/> Nombre del Impuesto.">
								Nombre
							</th>
							<th class="tooltip_trigger"
								title="Areal a que será aplicado.">
								Area
							</th>
							<th class="tooltip_trigger"
								title="Zona a la que reá aplicado. <br/>Nota: Si se establece un area esta tendra prioridad sobre la zona.">
								Zona
							</th>
							<th class="info_req tooltip_trigger"
								title="<strong>Requerido</strong><br/> Prcentaje sobre la base que supone el impuesto.">
								(%)
							</th>
							<th class="spacer_75 align_ctr tooltip_trigger" 
								title="Si se marca, el impuesto sera marcado como activo.">
								Estado
							</th>
							<th class="spacer_125 align_ctr tooltip_trigger" 
								title="Si se marca el impuesto será eliminado al actualizar el formulario.">
								Eliminar
							</th>
						</tr>
					</thead>
				<?php if (! empty($tax_data)) { ?>	
					...
					<tfoot>
						<tr>
							<td colspan="6">
								<input type="submit" name="update_tax" value="Actualizar Impuestos" class="link_button large"/>
							</td>
						</tr>
					</tfoot>
				<?php } else { ?>
					<tbody>
						<tr>
							<td colspan="6">
								No hay Impuestos  configurados.<br/>
