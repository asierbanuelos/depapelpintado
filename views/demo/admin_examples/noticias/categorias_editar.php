...
<head>
	<meta charset="utf-8">
	<title>Categorías noticias</title>
...
<body>
  ...
  <div class="container">
    ...
    print '</xmp></pre>';
    */
    echo form_open('admin_library/update_categoria_noticia');?>
      ...
      <div style="height: 20px"></div>
        ...
        <input type='hidden' name='idnoticia_categoria' id='idnoticia_categoria' value='<?php echo (int)$categoria->idnoticia_categoria;?>' />
        <div class="sec row"><div class="col two t-six m-six">Nombre:</div><?=  form_input("noticia_categoria_name",$categoria->noticia_categoria_name,'class="ten t-six m-six"')?></div>
        <div class="sec row">
  ...
  $(".close").click(function(){
    $(location).attr("href", "/admin_library/categorias_noticias");
  });
  </script>
</body>
</html>