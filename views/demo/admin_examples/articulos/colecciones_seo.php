...
<body>
  ...
  <div class="container">
    ...
    <div class="sec row">
      ...
      <div class="col six">
        <span class="edit btn" style='width: 100%;margin:0;'><a style="color: #fff;text-decoration: none;" href='/admin_library/colecciones_seo_ekam'>Ver estado de las colecciones en EKAM</a></span>
      </div>
    </div>
    <div class="list">
      <?php
            ...
            <div style="border-bottom:dotted 1px #aaa" class="sec row" id='registro_<?php echo $id; ?>'>
              ...
              <div class="col one">
                ...
                <span class="edit btn" id="<?php echo $id; ?>" style='width: 100%;'>
                  <a style="color: #fff;text-decoration: none;" href='/admin_library/editar_coleccion_seo/<?php echo $id; ?>'>Editar</a>
                </span>
                <span class="edit btn" id="precios_<?php echo $id; ?>" style='width: 100%;'>
                  <a style="color: #fff;text-decoration: none;" href='/admin_library/editar_precios_coleccion/<?php echo $id; ?>' target='_blank'>Precios</a>
                </span>
                <?php 
