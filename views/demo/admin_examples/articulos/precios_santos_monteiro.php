                ...
                foreach ($a_acabados_aux as $idacabado => $txt) {
                  ...
                  if (isset($a_precios[$idcol][$idacabado])){
                    foreach ($a_precios[$idcol][$idacabado] as $idprecio => $datos) {
                      ...
                      echo "<input type='text' name='a_precios[$idcol][$idacabado][$idprecio][$campo_precio]' value='$precio' size='7' />";
                    ...
                    echo "<input type='text' name='a_precios[$idcol][$idacabado][0][$campo_precio]' value='0' size='7' />";
