...
<body>
  ...
  <div class="container">
    ...
    <div class="sec row">
      ...
      <div class="col six">
        <span class="edit btn" style='width: 100%;margin:0;'><a style="color: #fff;text-decoration: none;" href='/admin_library/fabricantes_seo_ekam'>Ver estado de las fabricantes en EKAM</a></span>
      </div>
    </div>
    <div style="height: 20px"></div>
    <div class="list">
              ...
              <div class="col one">
                ...
                */
                ...
                <span class="edit btn" id="<?php echo $id; ?>" style='width: 100%;'>
                  <a style="color: #fff;text-decoration: none;" href='/admin_library/editar_fabricante_seo/<?php echo $id; ?>'>Editar</a>
                </span>
              </div>
