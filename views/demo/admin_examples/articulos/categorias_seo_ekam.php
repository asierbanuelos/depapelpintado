...
<?php $this->load->view('includes/demo_header'); ?>
  <div class="container">
    ...
    <div style="font-size:40px;font-weight: 300;color: #B05380;text-align:center;border-bottom: 1px solid #B05380;">ESTADO INFO SEO CATEGORÍAS EKAM</div>
    <div style="height: 20px"></div>
    <div class="sec row">
      <div class="col six">
        <span class="edit btn" style='width: 100%;margin:0;'><a style="color: #fff;text-decoration: none;" href='/admin_library/categorias_seo'>Info SEO categorías principal</a></span>
      </div>
    </div>
    <div class="list">
      <?php
          ...
          foreach ($a_datos_seo as $seo_completo=>$a_datos){
            foreach ($a_datos as $id=>$datos){
              ...
              <div style="border-bottom:dotted 1px #aaa;margin:0;padding:5px;<?php echo $inactivo; ?>" class="sec row" id='registro_<?php echo $id; ?>'>
                ...
                <div class="col one">
                  <span class="edit btn" id="<?php echo $id; ?>" style='width: 100%;'><a style="color: #fff;text-decoration: none;" href='/admin_library/editar_categoria_seo/<?php echo $id; ?>#info-ekam'>Editar</a></span>
                </div>
              </div>
              <?php
            }
    ...
    */
    function sendFileToServer(formData, status, ref){
      ...
      */
      ...
      var uploadURL = "<?= $includes_dir ?>grid/up006uy_ekam.php"; //Upload URL
