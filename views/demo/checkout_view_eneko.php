					    	...
					    	<div>
									<table id="tabla-login"  class='form-group-aux align-bottom'>
										<tr class='info_req'>
											...
											<td class=''>
					              <input id="checkout_login_email" class="form-control" name="checkout_login_email" type="email" value="" autocomplete="off" placeholder="E-mail" /> 
											</td>
										</tr>
										<tr class='info_req'>
											<td class=""><label for="checkout_login_pass">Contraseña:</label></td>
											<td class=''>
				                <input name="checkout_login_pass" id="checkout_login_pass" type="password" placeholder="Contraseña" autocomplete="off" class="form-control" />
											</td>
										</tr>
										<tr class='info_req'>
											<td class=""></td>
											<td class=''>
				                <input class="boton-opciones" type="submit" name="checkout_login" value="Iniciar sesión">
		    ...
		    <div class='row heading-producto'>
		    	<div class='cart-grid-body col-xs-12 col-lg-8' id='ajax_content'>
		    		<div class='border rounded'>
							...
							<div id='campos_datos_pedido' class='<?php echo $class_datos_form; ?>'>
					    	...
					    	<div>
									<table id="tabla-contacto"  class='form-group align-bottom'>
										<tr class='info_req'>
											...
											<td class=''>
												<input type="text" class='form-control' name="checkout[email]" id="checkout_email" required="" value="<?php echo set_value('checkout[email]',$usuario->email);?>" placeholder="Email" />
											</td>
										</tr>
										<tr class='info_req'>
											<td class=""><label for="checkout_phone">Teléfono*:</label></td>
											<td class=''>
												<input type="text" class='form-control' name="checkout[phone]" id="checkout_phone" required="" value="<?php echo set_value('checkout[phone]',$usuario->phone);?>" placeholder="Teléfono" />
											</td>
										</tr>
									</table>
					    	</div>
					    	...
					    	<div>
									<table id="tabla-envio"  class='form-group align-bottom'>
										...
										<tr class='info_req form-group align-bottom'>
											...
											<td>
												<select id="country_id" name="seleccion_pais[country]" class='form-control pais-envio'>
												<option value="0"> - País - </option>
												<?php 
												foreach($countries as $country){ 
